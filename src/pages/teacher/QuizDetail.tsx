      ...
      <div className="flex flex-wrap gap-3 mb-8">
        {quiz.status === 'published' && (
          <>
            ...
            <span className="inline-flex items-center rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 text-sm font-mono text-gray-700">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th className="text-left px-5 py-3 font-medium text-gray-500">Ergebnis</th>
                  <th className="text-left px-5 py-3 font-medium text-gray-500">Prozent</th>
                  <th className="text-left px-5 py-3 font-medium text-gray-500">Zeitpunkt</th>
                </tr>
              </thead>
                      ...
                      <tr key={session.id} className="group">
                        <td colSpan={4} className="p-0">
                          <button
                            ...
                            className="w-full grid grid-cols-[1fr_auto_auto_auto_auto] items-center text-left hover:bg-gray-50/50 transition-colors"
                          >
                            <span className="px-5 py-3 font-medium text-gray-900">{session.student_name}</span>
                            <span className="px-5 py-3 text-gray-700">
                            ...
                            <span className="px-3 py-3 text-gray-400">
